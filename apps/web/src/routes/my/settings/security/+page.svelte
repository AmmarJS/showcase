...
<div class="flex flex-col w-full h-full">
    <div class="w-full">
        <form action="?/updatePassword" method="POST" class="flex flex-col space-y-2 w-full">
            ...
            <Input id="oldPassword" label="Old Password" type="password" required></Input>
            <Input id="password" label="New Password" type="password" required></Input>
            <Input id="passwordConfirm" label="Confirm New Password" type="password" required></Input>
